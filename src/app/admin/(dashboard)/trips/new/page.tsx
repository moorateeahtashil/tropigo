    ...
    <form action={createAction} className="space-y-6">
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Title"><AdminInput name="title" required className="w-full" /></Field>
          <Field label="Slug"><input name="slug" required placeholder="south-island-tour" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Subtitle"><input name="subtitle" placeholder="Explore the South of Mauritius" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Field label="Trip Mode">
            <select name="trip_mode" defaultValue="guided_tour" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
          ...
          <Field label="Trip Type">
            <select name="trip_type" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
              <option value="">—</option>
          ...
          <Field label="Duration (minutes)"><input name="duration_minutes" type="number" min="0" placeholder="480" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          ...
          <Field label="Max Passengers"><input name="max_passengers" type="number" defaultValue={6} min={1} className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Pickup Included"><input name="pickup_included" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300" /></Field>
          <Field label="Dropoff Included"><input name="dropoff_included" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300" /></Field>
          <Field label="Pickup Location"><input name="pickup_location" placeholder="Hotel lobby, any hotel in the region" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Pickup Time"><input name="pickup_time" placeholder="08:00" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Dropoff Location" full><input name="dropoff_location" placeholder="Same as pickup" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
        </div>
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Included (comma-separated)" full><input name="included_items" placeholder="Hotel pickup, Guide, Lunch, Entrance fees" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"/></Field>
          <Field label="Excluded (comma-separated)" full><input name="excluded_items" placeholder="Drinks, Souvenirs, Optional activities" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"/></Field>
          <Field label="Highlights (comma-separated)" full><input name="highlights" placeholder="Grand Bassin, Chamarel Waterfall, Seven Colored Earths" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"/></Field>
        </div>
      </section>
...
// Wrap raw inputs to ensure consistent styling
function AdminInput(props: React.InputHTMLAttributes<HTMLInputElement>) {
  return <input {...props} className={`rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 ${props.className || ''}`} />
}

function AdminTextarea(props: React.TextareaHTMLAttributes<HTMLTextAreaElement>) {
  return <textarea {...props} className={`rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-y ${props.className || ''}`} />
}

function AdminSelect(props: React.SelectHTMLAttributes<HTMLSelectElement>) {
  return (
    <select {...props} className={`appearance-none rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 ${props.className || ''}`}>
      {props.children}
    </select>
  )
}
