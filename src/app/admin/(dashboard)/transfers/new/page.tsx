    ...
    <form action={createAction} className="space-y-6">
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <Field label="From Price (optional)"><input name="base_price" type="number" step="0.01" min="0" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Status">
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Field label="Pricing Model">
            <select name="pricing_model" defaultValue="fixed" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
          ...
          <Field label="Vehicle Type">
            <select name="vehicle_type" defaultValue="sedan" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
          ...
          <Field label="Max Passengers"><input name="max_passengers" type="number" defaultValue={4} min={1} className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Max Luggage"><input name="max_luggage" type="number" min={0} className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Includes Meet & Greet"><input name="includes_meet_greet" type="checkbox" className="h-4 w-4 rounded border-gray-300" /></Field>
          <Field label="Includes Flight Tracking"><input name="includes_flight_tracking" type="checkbox" className="h-4 w-4 rounded border-gray-300" /></Field>
          <Field label="Base Fare"><input name="base_fare" type="number" step="0.01" min="0" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Per KM Rate"><input name="per_km_rate" type="number" step="0.0001" min="0" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Waiting Fee / Hour"><input name="waiting_fee_per_hour" type="number" step="0.01" min="0" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Notes" full><textarea name="notes" rows={2} className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
        </div>
      </section>
