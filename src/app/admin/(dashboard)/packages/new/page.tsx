    ...
    <form action={createAction} className="space-y-6">
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <Field label="Base Price (optional)"><input name="base_price" type="number" step="0.01" min="0" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Status">
      ...
      <section className="rounded-2xl border border-sand-200 bg-white p-5 shadow-card">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Field label="Pricing Mode">
            <select name="pricing_mode" defaultValue="computed" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
              <option value="fixed">Fixed</option>
              <option value="computed">Computed</option>
              <option value="computed_with_discount">Computed with Discount</option>
            </select>
          </Field>
          <Field label="Discount %"><input name="discount_percent" type="number" min="0" max="100" defaultValue={0} className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Duration (days)"><input name="duration_days" type="number" min="1" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
          <Field label="Highlights (comma-separated)" full><input name="highlights" className="w-full rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500" /></Field>
