...
export default async function DestinationsList({ searchParams }: { searchParams: { q?: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="flex gap-2">
        <input name="q" defaultValue={q} placeholder="Search by name" className="w-72 rounded-lg border-sand-300 text-sm shadow-sm focus:border-brand-500 focus:ring-brand-500" />
