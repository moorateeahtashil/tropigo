    ...
    return (
      <form onSubmit={handleSubmit} className={cn('flex gap-2', className)}>
        <input
          ...
          className="flex-1 rounded-lg border border-white/20 bg-white/10 px-3 py-2 text-sm text-white placeholder-white/60 backdrop-blur-sm focus:border-white/40 focus:outline-none focus:ring-1 focus:ring-white/40"
        />
        <Button
          type="submit"
          size="sm"
    ...
    <form onSubmit={handleSubmit} className={cn('space-y-2', className)}>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border-sand-300 shadow-sm focus:border-brand-500 focus:ring-brand-500"
        />
